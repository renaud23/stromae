      ...
      <Accordion label="Quel est le cadre légal de l'enquête&nbsp;?">
        <p>
          ...
          <Link
            ...
            rel={
              props.welcome.Loi_statistique.target === '_blank'
                ? 'noopener noreferrer'
                : undefined
            }
          >
        ...
        <p>
          ...
          {props.welcome.Enq_ParutionJo !== undefined &&
        ...
        <p>
          ...
          <Link
            ...
            rel={
              props.welcome.Loi_rgpd.target === '_blank'
                ? 'noopener noreferrer'
                : undefined
            }
          >
          ...
          <Link
            ...
            rel={
              props.welcome.Loi_informatique.target === '_blank'
                ? 'noopener noreferrer'
                : undefined
            }
          >
